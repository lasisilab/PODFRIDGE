...
#"#5E8BFF26", "#5E8BFF3D", "#5E8BFF70", "#5E8BFFA6","#5E8BFFE8", "#5E8BFF", "#DE3A8A"
```
...
ggplot(select_states |>
  ...
  scale_fill_manual(values = c("#5E8BFF3D", "#5E8BFF70", "#5E8BFFA6", "#5E8BFF", "#DE3A8A")) +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
...
#       x = NULL,
#       y = "Proportion") +
#  scale_fill_manual(values = c("#5E8BFF26", "#5E8BFF3D", #"#5E8BFF70", "#5E8BFFA6", "#5E8BFF", "#DE3A8A")) +
#  theme_minimal() +
...
ggplot(summary_data_annual_pie, aes(x ="", y = avg_data_annual, fill = race_category)) +
  ...
  labs(title = "Average Proportion of DNA Collected Annually (Across All States)",
       fill = "Race") +
  scale_fill_manual(values = c("#5E8BFF", "#DE3A8A", "#5E8BFF3D"))
