...
### State Demographics
Below are some summary statistics of the racial demographics in each state.
...
average_black_database <- race_totals |> 
  ...
  summarise(average_value = mean(proportion_value, na.rm = TRUE))
...
These summary statistics describe the racial breakdown of DNA collected annually by state.
[describe this data]
...
data_annual <- data_race |> 
  filter(str_detect(variable_detailed, "_annual"))
