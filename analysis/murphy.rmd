...
ggplot(data_gender_simplified, aes(x = State, y = total_value, fill = simplified_sex)) +
  ...
  labs(y = "Proportion", x = "State", title = "Gender Distribution by State", fill = "Sex") +
  theme_minimal() +
...
ggplot(data_offender_type_summarized, aes(x = "", y = total_value, fill = variable_detailed)) +
  ...
  labs(title = "Distribution of Offender Types", caption = "Data from California, Indiana, Texas, and Nevada", fill = "Offender Type") +
