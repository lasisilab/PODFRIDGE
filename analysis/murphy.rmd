...
ggplot(data_gender_simplified, aes(x = State, y = total_value, fill = simplified_sex)) +
  ...
  scale_fill_manual(values = c("#7253FF", "#f77A2E", "#D8DCDA")) +  # color palette
...
ggplot(data_offender_type_summarized, aes(x = "", y = total_value, fill = variable_detailed)) +
  ...
  scale_fill_manual(values = c("#5E8BFF", "#DE3A8A"))
...
ggplot(race_totals |> 
  ...
  labs(title = "Race Totals in DNA Database by State",
       ...
       y = "Proportion",
       fill = "Race Category") +
  scale_fill_manual(values = c("#5E8BFF26", "#5E8BFF3D", "#5E8BFF70", "#5E8BFFA6","#5E8BFFE8", "#5E8BFF", "#DE3A8A")) +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
ggplot(select_states |>
  ...
  scale_fill_manual(values = c("#5E8BFF3D", "#5E8BFF70", "#5E8BFFA6","#5E8BFFE8", "#5E8BFF", "#DE3A8A")) +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
ggplot(summary_data_annual_pie, aes(x ="", y = avg_data_annual, fill = race_category)) +
  ...
  labs(title = "Average Proportion of DNA Collected Annually (Across All States)",
       fill = "Race") +
  scale_fill_manual(values = c("#5E8BFF", "#DE3A8A", "#FFB000B5"))
