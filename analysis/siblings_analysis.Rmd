...
ggplot(df_age_black, aes(x = normalized_freq, y = Age_bin, fill = normalized_freq)) +
  geom_bar(stat = "identity", position = "dodge", width = 0.8) +
  geom_vline(xintercept = 0, color = "black", linetype = "dashed") +
  facet_wrap(~YEAR, scales = "free_y") +
  scale_fill_gradient2(low = "blue", high = "red", midpoint = median(df_age_black$normalized_freq, na.rm = TRUE), 
                       name = "Normalized\nFrequency") +
