...
```{r}
blue_colors <- c("#0000FF", "#0000E5", "#0000CC", "#0000B2", "#000099", "#00007F", "#000066", 
                 "#00004C", "#000033", "#000019", "#3333FF", "#6666FF", "#9999FF")

unique_chborn_num <- sort(unique(mother_data$chborn_num))
color_mapping <- setNames(blue_colors, unique_chborn_num)
```
...
```{r}
ggplot(df_long1, aes(x = x_axis, y = frequency, fill = as.factor(x_axis))) +
  geom_col() +
  ...
  scale_fill_viridis_d(option = "plasma", name = "Number of Children/Siblings") +
