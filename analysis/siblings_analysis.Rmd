...
<<<<<<< HEAD
Here, we are trying to create a frequency table for each race to show the number of children born, the number of mothers who have "chborn_num" children, the number of siblings, and the number of individuals who have "n_sib" siblings. 
=======
