...
## 5.Distribution of Number of Children by Age and Year(Black/African American)
...
ggplot(df_age_black, aes(x = normalized_freq, y = Age_bin, fill = chborn_num)) +
...
ggplot(df_age_black, aes(x = normalized_freq, y = Age_bin, fill = chborn_num)) +
  geom_bar(stat = "identity", position = "stack", width = 0.8, color = alpha("black", 0.3)) +
  geom_vline(xintercept = 0, color = "black", linetype = "dashed") +
  facet_wrap(~YEAR, scales = "free_y") +
  scale_fill_gradientn(colors = c("#FFF5F0", "#FEE0D2", "#FCBBA1", "#FC9272", "#FB6A4A", "#EF3B2C", "#CB181D", "#99000D"),
    name = "Number of Children") +
