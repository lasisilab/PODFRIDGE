...
```{r}
# Pre-initialize parallel backend
...
```{r}
# Microbenchmarking the efficient function
benchmark <- microbenchmark(
  efficient = process_simulation_setup(
    simulation_setup, df_allelefreq, kinship_matrix, loci_list, loci_lists, 
    "data/processed_genotypest.csv", "data/summary_genotypes.csv"
  ),
  times = 10
)
