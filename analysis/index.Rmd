...
The POPFORGE (**Pop**ulation Differences in **For**ensic Identification of **Ge**netic Relatives) project aims to address this question by using mathematical estimations of genetic relatedness based on previous methods, as well as simulating pedigrees and genomes for two populations based on input parameters. Additionally, demographic data from the US Census microdata will be used to obtain population size information on European and African Americans.
