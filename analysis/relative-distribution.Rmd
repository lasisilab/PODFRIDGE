...
df <- select(mother_data, YEAR, SEX, AGE, BIRTHYR, RACE, CHBORN, AGE_RANGE, chborn_num)
...
theta_nb_black <- standard_nb$theta
exp_zero_nb_black <- (theta_nb / (theta_nb_black + mean_black))^theta_nb_black
