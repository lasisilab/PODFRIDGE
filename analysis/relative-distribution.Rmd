...
Understanding family size differences across populations is crucial for assessing disparities in genetic surveillance. Larger family sizes increase the number of first-degree relatives, enhancing the probability of an individual being identified through familial DNA searches. This supplementary text provides a detailed analysis of family size distributions among African American and European American populations using U.S. Census data from 1960 to 1990, highlighting key findings such as the paradoxical bimodal distribution in the number of children among African American women.
