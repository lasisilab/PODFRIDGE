...
```{r}
merged_black = summary_table %>% filter(Race == "Black/African American")
merged_white = summary_table %>% filter(Race == "White")
...
sum_table_black = sum_table_sib %>% filter(Race == "Black/African American")
sum_table_white = sum_table_sib %>% filter(Race == "White")
```
