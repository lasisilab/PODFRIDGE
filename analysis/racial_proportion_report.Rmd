...
knitr::opts_knit$set(base.dir = "https://github.com/lasisilab/PODFRIDGE/raw/main/")
```
...
![Summary statistics of binomial regression for Black People](figure/racial_breakdown/glm_black.png "Summary statistics of Black People")

![Summary statistics of binomial regression for White People](figure/racial_breakdown/glm_white.png "Summary statistics of White People")
...
![Goodness-of-Fit for racial breakdown using binomial regression](figure/racial_breakdown/goodness_of_fit.png "Goodness-of-Fit")
...
![Racial breakdown of Census and CODIS for each state](figure/racial_breakdown/racial_breakdown.png "Racial Composition")
...
![Absolute difference of racial proportions](figure/racial_breakdown/abs_difference.png "Absolute Difference")

![Relative difference of racial proportions](figure/racial_breakdown/rela_difference.png "Relative Difference")
...
![Widths of confidence intervals for racial proportions](figure/racial_breakdown/interval_widths.png "Interval Widths")
