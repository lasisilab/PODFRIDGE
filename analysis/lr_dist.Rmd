...
#ggplot(combined_lrs, aes(x = relationship_known_factor, y = LR, fill = population)) +
#    geom_boxplot(position = position_dodge(width = 0.9)) +
#    facet_wrap(.~relationship_tested,nrow = 5, scales = "free_y") +
#    labs(
...
ggplot(proportions_exceeding_cutoffs_long_parent_child, aes(x = relationship_known_factor, y = Value, fill = population_label, color = population_label)) +
...
ggplot(proportions_exceeding_cutoffs_siblings, aes(x = relationship_known_factor, y = Value, fill = population_label, color = population_label)) +
  geom_bar(stat = "identity", position = position_dodge(width = 0.9)) +
  facet_grid(cutoff_label ~ loci_set_factor, scales = "fixed") +
  labs(
