...
us_state_density_black = as.data.frame(us_state_density[,c("state","all","census.num.black","census.percent.black","incarcerated_total",
                                       "incarcerated_black","percent.incar","arrestee_profiles","offender_profiles","black_profiles")])
...
SDIS_offender = lm(N_offenders.SDIS ~ census.num.black + census.num.white + incarcerated_black + incarcerated.white + N_offenders.NDIS, data = SDIS_offenders)
...
SDIS_regression$SDIS.offender.prediction = SDIS_offender$coeff[1] + SDIS_offender$coeff[2] * SDIS_regression$census.num.black +
                                                             ...
                                                             SDIS_offender$coeff[5] * SDIS_regression$incarcerated.white +
