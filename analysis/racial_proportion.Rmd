...
```{r Summary statistics of binomial regression for Black People, echo=FALSE}
summary(binomial_regression_black)
```


```{r Summary statistics of binomial regression for White People, echo=FALSE}
...
```{r Goodness-of-Fit for racial breakdown using binomial regression, echo=FALSE}
# goodness of fit
...
```{r Racial breakdown of Census and CODIS for each state, echo=FALSE}
...
```{r Absolute difference of racial proportions, echo=FALSE}
...
```{r Relative difference of racial proportions, echo=FALSE}
...
```{r Widths of confidence intervals for racial proportions, echo=FALSE}
