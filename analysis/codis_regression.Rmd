...
plot_proportions(weighted_props_all_census) + ggtitle("National racial breakdown of Census database")
plot_proportions(weighted_props_all_sdis) + ggtitle("Estimated national racial breakdown of SDIS database")
```
