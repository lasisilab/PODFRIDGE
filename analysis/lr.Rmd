...
In the instance where only one allele matches between profile A and profile C, $M_2$ would be doubled to account for either allele being the one that is IBD vs IBS, making $M_2 = 2{p_A}^2$.
