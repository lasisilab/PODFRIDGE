...
plot_number_matches <- function(rep_direct, rep_or, N_pop, name) {
    num_K = 10000
    m = 6
    min_num_seg = 2
    r = 2.5
...
plot_number_matches(rep(1, 10), rep(1, 10), US_POP_1990, "Number of Matches by Relationship vs Database Size")
