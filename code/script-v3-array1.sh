...
#This is the first of three scripts for an array submission in which jobs 2 and 3 are dependent on previous completion of job 1 (this job). 
...
R CMD BATCH --no-save --no-restore simulate_genotypes.R 2000 4000 script_$SLURM_ARRAY_TASK_ID
